...
@section('content')
<h2>Add Admin</h2>
<form class="uk-padding-small" action="{{ route('storeAdmin') }}" method="post">
@csrf
<div class="uk-margin">
    <label class="uk-form-label" for="form-stacked-text">Nama</label>
    <div class="uk-form-controls">
        <input name="name" class="uk-input" id="form-stacked-text" type="text" placeholder="Nama Lengkap">
    </div>
</div>
...
<div class="uk-margin">
    ...
    <div class="uk-form-controls">
        <input name="email" class="uk-input" id="form-stacked-text" type="email" placeholder="Email login">
    </div>
</div>
<div class="uk-margin">
...
<div class="uk-margin">
    <div class="uk-form-controls">
        <input class="uk-align-right uk-button uk-button-primary" id="form-stacked-text" type="submit" value="Tambah">
    </div>
</div>
</form>
@endsection
